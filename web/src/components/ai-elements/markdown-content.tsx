      ...
      <ReactMarkdown
        ...
        components={{
          ...
          th: ({ children, ...props }: { children?: React.ReactNode;[key: string]: any }) => (
            <th className="border border-border px-4 py-3 text-left font-semibold text-sm bg-muted/50 whitespace-nowrap" {...props}>
              {children}
            </th>
          ),

          td: ({ children, ...props }: { children?: React.ReactNode;[key: string]: any }) => (
            <td className="border border-border px-4 py-3 text-sm align-top" {...props}>
              {children}
            </td>
          ),
