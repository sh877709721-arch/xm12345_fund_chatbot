...
例如: 
"X 是 Y 公司的所有者，受到多项不法行为指控 [来源: [2](2), [7](7),[34](34),[46](46),[graph_chunk](graph_chunk), +more)]。
...
政治话题禁止回答
类似的表达：
    1)更多详情可参考：[文件](doc_10821)、[文件](doc_10820)、[文件](doc_10817)。
    2)更多详情可参考：。
出现多个**主语**,**重复论述**，例如“您妈妈作为厦门职工医保参保人员的非本市户籍父母”，“如果您妈妈是您（厦门职工医保参保人员）的非厦门户籍配偶” 此类的社会关系错误表达
